...
export default function CodeChallenge({ quest }) {
    ...
    return (
        <MainLayout fullWidth>
            ...
            <div className="flex h-full w-full flex-col font-display flex-1">
                    ...
                    <div className="flex flex-col overflow-hidden rounded-xl border-4 border-black bg-white shadow-[4px_4px_0px_#000]">
                        ...
                        <div className="flex border-b-4 border-black">
                            <button
                                ...
                                className={`flex-1 border-r-4 border-black py-3 text-base font-bold text-black ${tab === 'instructions' ? 'bg-lime-400/20' : 'hover:bg-lime-400/10'}`}
                            >
                                Instructions
                            </button>
                            <button
                                onClick={() => setTab('testcases')}
                                className={`flex-1 py-3 text-base font-bold text-black ${tab === 'testcases' ? 'bg-lime-400/20' : 'hover:bg-lime-400/10'}`}
                            >
                                Test Cases
                            </button>
                        </div>
                        ...
                        <div className="flex-1 space-y-6 overflow-y-auto p-6">
                            {tab === 'instructions' ? (
                                <div className="prose prose-sm max-w-none text-black">
                                    <div className="mb-6 rounded-md border-2 border-black bg-lime-100 p-4 shadow-[2px_2px_0px_#000]">
                                        <p className="font-bold text-black mb-1">💡 Grading Tip:</p>
                                        <p className="text-sm text-black m-0">
                                            Define a function (e.g., <code>solve(input)</code>). The <strong>last defined function</strong> in your code will be automatically executed with the test case input.
                                        </p>
                                    </div>
